 ...
 */
final class Version20191201235704 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rent DROP bedrooms');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rent ADD bedrooms SMALLINT NOT NULL');
    }
}
